...
public class UserDto {
	...
	//constructor
    public UserDto(String user_coment, String user_editdate, String user_dedate, String email, String user_nickname,
			int user_grade, int user_char_count, int user_char_maxcount, int user_gmcount, String user_indate) {
		super();
	...
	public String toString() {
		return "UserDto [user_coment=" + user_coment + ", user_editdate=" + user_editdate + ", user_dedate="
				+ user_dedate + ", email=" + email + ", user_nickname=" + user_nickname + ", user_grade=" + user_grade
				+ ", user_char_count=" + user_char_count + ", user_char_maxcount=" + user_char_maxcount
				+ ", user_gmcount=" + user_gmcount + ", user_indate=" + user_indate + "]";
	}
	//Getter//setter
